...
// Gebruikt op de Producten-lijstpagina: navigeert normaal naar het
// aanmaakformulier, maar toont bij het bereiken van de Gratis-catalogus-
    ...
    return (
      <>
        ...
        <UpgradeModal
          ...
          description={`Het Gratis-pakket biedt plek voor maximaal ${GRATIS_CATALOGUS_LIMIET} producten. Upgrade naar Plus of Pro voor onbeperkt producten.`}
        />
      </>
    );
  }
