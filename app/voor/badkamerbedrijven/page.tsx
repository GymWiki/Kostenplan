...
const doelgroep = getDoelgroep("badkamerbedrijven")!;

export const metadata: Metadata = {
  title: { absolute: `${doelgroep.title} | Kostenplan` },
  description: doelgroep.description,
  alternates: { canonical: "/voor/badkamerbedrijven" },
  openGraph: {
    title: `${doelgroep.title} | Kostenplan`,
    description: doelgroep.description,
    url: "/voor/badkamerbedrijven",
    siteName: "Kostenplan",
    locale: "nl_NL",
    type: "website",
...
export default function BadkamerbedrijvenPage() {
