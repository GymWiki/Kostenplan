...
import { createToolFromTemplateAction, type TemplateToolFormState } from "@/app/lib/actions/tools";
...
// "Kies een startpunt" (Deel 28): templates + een lege rekentool, in twee
// stappen — eerst kiezen, dan een naam geven. Geen tussenpagina die zegt
// "deze tool is gekoppeld aan template X" (Deel 29): na het aanmaken is de
// tool volledig zelfstandig, precies zoals createToolFromTemplateAction het
// bouwt.
...
function TemplateNaamStap({ template, onTerug }: { template: TemplateSamenvatting; onTerug: () => void }) {
  const action = createToolFromTemplateAction.bind(null, template.id);
